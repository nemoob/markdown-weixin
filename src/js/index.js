...
// 应用标题颜色（使用行内样式，确保粘贴到微信时能保留）
OnlineMarkdown.applyHeadingColor = function(color) {
  $('#output .wrapper h1, #output .wrapper h2, #output .wrapper h3, #output .wrapper h4, #output .wrapper h5, #output .wrapper h6').css('color', color);
};
...
// 绑定标题颜色选择器
$(function() {
  $('.title-color-picker').on('input change', function() {
    var color = $(this).val();
